...
import { Camera, Video, Maximize, ChevronDown, Plus, Loader2, X } from 'lucide-react';
...
const AddProduct = () => {
    ...
    // Form State – Product Information + Technical Information (per spec)
    ...
    const handleFileChange = (e, key) => {
        ...
        if (isImage && file.size > MAX_IMAGE_BYTES) {
            alert(`Image must be under ${MAX_IMAGE_SIZE_MB}MB. This file is ${(file.size / 1024 / 1024).toFixed(2)}MB.`);
            e.target.value = '';
            return;
        }
    ...
    const handleSaveProduct = async () => {
        ...
        setIsSaving(true);
        try {
            // 1. Upload image/video files to Firebase Storage (display URLs used in frontend)
            const photoUrls = [];
            ...
            const videoUrl = await uploadFile(files.video, 'products/videos');
            const view360Url = await uploadFile(files.view360, 'products/360views');
                ...
                <div className="dashboard-content">
                    ...
                    <div className="add-product-grid">
                        <div className="form-section card">
                            ...
                            <p className="section-subtitle">Fill in the essential details for your new product.</p>
                            ...
                            <div className="form-row">
                                ...
                                <div className="form-group flex-1">
                                    <label>Price</label>
                                    <input type="number" placeholder="Input Price" value={formData.price} onChange={(e) => setFormData({ ...formData, price: e.target.value })} />
                                </div>
                            </div>
                                ...
                                <div className="form-group flex-1">
                                    ...
                                    <div className="select-wrapper">
                                        <select value={formData.frameShape} onChange={(e) => setFormData({ ...formData, frameShape: e.target.value })}>
                                            ...
                                            <option>Rectangle (Blue)</option>
                                            <option>Rectangle (Black)</option>
                                            <option>Round</option>
                            ...
                            <div className="form-group">
                                ...
                                <input type="text" placeholder="e.g. UV Protection, Polarized" value={formData.feature} onChange={(e) => setFormData({ ...formData, feature: e.target.value })} />
                            </div>
                        </div>
                        ...
                        <div className="upload-section card">
                            ...
                            <div className="media-upload-extra">
                                ...
                                <div className="video-upload-row">
                                    ...
                                    >
                                        ...
                                        />
                                        {previews.video ? (
                                            <div className="video-preview-placeholder">Video added</div>
                                        ) : (
                                            <>
                            ...
                            <div className="save-btn-container">
                                <button
                                    ...
                                    disabled={isSaving}
                                >
                                    {isSaving ? <><Loader2 className="animate-spin mr-2" size={18} /> Processing...</> : 'Save Product'}
                                </button>
                            </div>
                        </div>
                    </div>
